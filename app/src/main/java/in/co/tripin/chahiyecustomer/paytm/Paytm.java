package in.co.tripin.chahiyecustomer.paytm;
...
public class Paytm {
    ...
    public Paytm(String mId, String channelId,String orderId, String custId, String txnAmount, String website, String callBackUrl, String industryTypeId, String mobile, String email) {
        this.mId = mId;
